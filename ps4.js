...
function setupRW() {
	...
	document.getElementById('load').innerHTML='<tr>'+
			...
			'</tr><tr><td><br/></td></tr>'+
			'<tr>'+
			'<td align="center" colspan="2"><a href="#" id="disableupdates" class="button" onclick="toggle_payload(\'disableupdates\'); return false" style="width:43%">Desativar Updates</a>&nbsp;'+
			'<a href="#" id="enableupdates" class="button" onclick="toggle_payload(\'enableupdates\'); return false" style="width:43%">Ativar Updates</a>&nbsp;</td>'+
			'</tr><tr><td><br/></td></tr>'+
			'<tr>'+
